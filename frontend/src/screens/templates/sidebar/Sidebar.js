      ...
      <ul>
          ...
          <>
            ...
            {activeMenu === "recruitment" && (
              <ul className="sub-menu">
                ...
                <li
                  onClick={() =>
                    handleNavigation("/Dashboards/recruitment-survey")
                  }
                >
                  Recruitment Survey
                </li>
          ...
          <ul className="sub-menu">
            ...
            {(role === "hr" || role === "admin") && (
              <>
                <li
                  onClick={() =>
                    handleNavigation("/Dashboards/onboarding-view")
                  }
                >
                  Onboarding View
                </li>
                <li
                  onClick={() =>
                    handleNavigation("/Dashboards/candidates-view")
                  }
                >
                  Candidates View
                </li>
          ...
          <>
            ...
            {activeMenu === "reports" && (
              <ul className="sub-menu">
                <li
                  onClick={() =>
                    handleNavigation("/Dashboards/employee-report")
                  }
                >
                  Employee Report
                </li>
          ...
          <ul className="sub-menu">
            {(role === "hr" || role === "admin" || role === "manager") && (
              <>
                <li
                  onClick={() =>
                    handleNavigation("/Dashboards/attendance-dashboard")
                  }
                >
                  Dashboard
                </li>
                <li
                  onClick={() =>
                    handleNavigation("/Dashboards/biometric-devices")
                  }
                >
                  Biometric Devices
                </li>
                <li
                  onClick={() =>
                    handleNavigation("/Dashboards/attendance-records")
                  }
                >
                  Attendance Records
                </li>
                <li
                  onClick={() =>
                    handleNavigation("/Dashboards/time-off-requests-admin")
                  }
                >
        ...
        {activeMenu === "leave" && (
          <ul className="sub-menu">
            ...
            {(role === "hr" || role === "admin" || role === "manager") && (
              <li
                onClick={() => handleNavigation("/Dashboards/leave-requests")}
              >
                Leave Requests
              </li>
            )}
          ...
          <ul className="sub-menu">
            {(role === "hr" || role === "admin") && (
              <>
                <li
                  onClick={() =>
                    handleNavigation("/Dashboards/payroll-dashboard")
                  }
                >
                  Dashboard
                </li>
                <li
                  onClick={() => handleNavigation("/Dashboards/payroll-system")}
                >
                  Payroll system
                </li>
        ...
        {activeMenu === "offboarding" && (
          <ul className="sub-menu">
            {(role === "hr" || role === "admin" || role === "manager") && (
              <>
                <li
                  onClick={() => handleNavigation("/Dashboards/exit-process")}
                >
                  Exit Process
                </li>
                ...
                <li
                  onClick={() =>
                    handleNavigation("/Dashboards/resignation-review")
                  }
                >
                  Resignation Review
                </li>
          ...
          <>
            ...
            {activeMenu === "assets" && (
              <ul className="sub-menu">
                <li
                  onClick={() =>
                    handleNavigation("/Dashboards/assets-dashboard")
                  }
                >
                  Dashboard
                </li>
                <li
                  onClick={() => handleNavigation("/Dashboards/asset-batches")}
                >
                  Asset Batches
                </li>
                <li
                  onClick={() => handleNavigation("/Dashboards/asset-history")}
                >
                  Asset History
                </li>
              </ul>
          ...
          <>
            ...
            {activeMenu === "configuration" && (
              <ul className="sub-menu">
                ...
                <li
                  onClick={() => handleNavigation("/Dashboards/company-leaves")}
                >
                  Company Leaves
                </li>
                <li
                  onClick={() =>
                    handleNavigation("/Dashboards/restrict-leaves")
                  }
                >
                  Restrict Leaves
                </li>
                <li
                  onClick={() =>
                    handleNavigation("/Dashboards/user-management")
                  }
                >
                  User Management
                </li>
