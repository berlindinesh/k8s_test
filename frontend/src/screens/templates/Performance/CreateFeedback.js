    ...
    const fetchEmployees = async () => {
      try {
        ...
        const formattedEmployees = response.data.map((emp) => ({
          ...
          designation:
            emp.joiningDetails?.initialDesignation || "No Designation",
            ...
            <Grid container spacing={3}>
              ...
              <Grid item xs={12}>
                ...
                <Autocomplete
                  ...
                  onChange={(event, newValue) =>
                    handleEmployeeSelect("employee", newValue)
                  }
              ...
              <Grid item xs={12} md={6}>
                ...
                <Autocomplete
                  ...
                  onChange={(event, newValue) =>
                    handleEmployeeSelect("manager", newValue)
                  }
                  renderOption={(props, option) => (
                    <Box
                      component="li"
              ...
              <Grid item xs={12} md={6}>
                ...
                <Autocomplete
                  ...
                  onChange={(event, newValue) =>
                    handleEmployeeSelect("subordinates", newValue)
                  }
                  renderOption={(props, option) => (
                    <Box
                      component="li"
              ...
              <Grid item xs={12} md={6}>
                ...
                <Autocomplete
                  ...
                  onChange={(event, newValue) =>
                    handleEmployeeSelect("colleague", newValue)
                  }
                  renderOption={(props, option) => (
                    <Box
                      component="li"
